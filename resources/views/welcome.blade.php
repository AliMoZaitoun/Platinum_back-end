...
<head>
    ...
    <style>
        ...
        @layer utilities {
            ...
            @attachments(min-width:40rem) {
                .container {
                    max-width: 40rem
                }
            }

            @attachments(min-width:48rem) {
                .container {
                    max-width: 48rem
                }
            }

            @attachments(min-width:64rem) {
                .container {
                    max-width: 64rem
                }
            }

            @attachments(min-width:80rem) {
                .container {
                    max-width: 80rem
                }
            }

            @attachments(min-width:96rem) {
                .container {
                    max-width: 96rem
                }
            }
            ...
            @attachments(prefers-color-scheme:dark) {
                .dark\:border-\[\#3E3E3A\] {
                    border-color: #3e3e3a
                }
            ...
            @attachments(prefers-reduced-motion:no-preference) {
                @starting-style {
