    ...
    public function run()
    {
        ...
        foreach ($buildings as $building) {
            ...
            for ($i = 1; $i <= $unitsToCreate; $i++) {
                ...
                $area = $type === 'social' ? rand(90, 140) : rand(180, 350);
                ...
                /*
                |--------------------------------------------------------------------------
                | 🖼️ رفع صور ومخططات الشقق إلى سيرفر S3 (معلّق مؤقتاً)
                |--------------------------------------------------------------------------
                | قم بفك التعليق عند الحاجة لتوليد الصور وضخها إلى S3 مباشرة
                |
                ...
                foreach ($images as $nameType => $rgb) {
                    ...
                    try {
                        ...
                        $unit->attachments()->create([
                            ...
                            'type'              => 'image',
                            'custom_properties' => ['size_bytes' => 1024 * rand(50, 200)],
                            'recorded_at'       => now(),
                        ]);
                    } catch (\Exception $e) {
                        // تجاهل الخطأ في حال تعذر الاتصال بـ S3 أثناء التطوير المحلي
                    }
                }
                */
            }
        ...
        $this->command->info("🎯 Done Seeding! Successfully created {$totalUnitsCreated} units matching your exact schema with realistic prices.");
    }
}
